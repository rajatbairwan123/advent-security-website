...
/**
 * Template Name: Mobile Patrols
 * Template Post Type: page
 *
 * Advent Security — Mobile Patrols
 */

get_header();
?>

<main class="mobile-patrols-page">
                ...
                <div class="col-lg-6">
                    <div class="section-content">
                        ...
                        <h2>
                            ...
                            <span>when your property needs it.</span>
                        </h2>
    ...
    <section class="content-section mobile-patrol-services">
        ...
        <div class="container">
            ...
            <div class="mobile-patrol-section-intro">
                ...
                <p>
                    Mobile patrol services can be structured around your
        ...
        <div class="container">
            ...
            <div class="mobile-patrol-coverage-intro">
                ...
                <h2>
                    ...
                    <span>that need regular oversight.</span>
                </h2>

                <p>
                    Mobile patrols can be used as a standalone security
                    measure or as part of a broader security program.
            ...
            <div class="mobile-patrol-process-grid">
                ...
                <div class="mobile-patrol-process-intro">
                    ...
                    <h2>
                        ...
                        <span>around your property.</span>
                    </h2>

                    <p>
                        Effective mobile patrols begin with understanding
            ...
            <div class="mobile-patrol-why-grid">
                ...
                <div class="mobile-patrol-why-content">
                    ...
                    <h2>
                        ...
                        <span>a broader security strategy.</span>
                    </h2>
        ...
        <div class="container">
            ...
            <div class="related-services-header">
                <div>
                    ...
                    <p>
                        Mobile patrols can complement electronic security
                    ...
                    <details>
                        ...
                        <div class="mobile-patrol-faq-answer">
                            <p>
                                ...
                                marked or appropriate security vehicles to
                    ...
                    <details>
                        ...
                        <div class="mobile-patrol-faq-answer">
                            <p>
                                ...
                                arrangements. Patrols can be scheduled at
                    ...
                    <details>
                        ...
                        <div class="mobile-patrol-faq-answer">
                            <p>
                                ...
                                applicable. Response procedures depend on the
                    ...
                    <details>
                        ...
                        <div class="mobile-patrol-faq-answer">
                            <p>
                                ...
                                areas, buildings and other vulnerable
                    ...
                    <details>
                        ...
                        <div class="mobile-patrol-faq-answer">
                            <p>
                                ...
                                periodic mobile presence and site checks,
                                while security guards provide continuous
