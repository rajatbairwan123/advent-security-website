<?php
/*
 * Template Name: Loss Prevention
 */

get_header();
?>

<main class="loss-prevention-page">

    <!-- =========================================================
         HERO
    ========================================================== -->
    <section class="loss-hero">
        <div class="container-fluid px-0">
            <div class="loss-hero-grid">

                <div class="loss-hero-content">
    ...
    <!-- =========================================================
         OVERVIEW
    ========================================================== -->
    <section class="loss-overview" id="loss-prevention-overview">
        <div class="container">

            <div class="loss-overview-grid">

                <div class="loss-overview-heading">
                    <span class="eyebrow">A PROACTIVE APPROACH</span>

                    <h2>
                        Loss Prevention Starts
                        <span>Before Loss Occurs.</span>
                    </h2>
                </div>
    ...
    <!-- =========================================================
         COMMON LOSS RISKS
    ========================================================== -->
    <section class="loss-risks">
        <div class="container">

            <div class="loss-section-header">
                <div>
                    <span class="eyebrow">UNDERSTANDING THE RISK</span>
            ...
            <div class="loss-risk-grid">

                <article class="loss-risk-card">
                    <!-- <span class="loss-card-number">01</span> -->

                    <div class="loss-risk-icon">
                ...
                <article class="loss-risk-card">
                    <!-- <span class="loss-card-number">02</span> -->
                ...
                <article class="loss-risk-card">
                    <!-- <span class="loss-card-number">03</span> -->
                ...
                <article class="loss-risk-card">
                    <!-- <span class="loss-card-number">04</span> -->
    ...
    ========================================================== -->
    <section class="loss-protection">
        <div class="container">

            <div class="loss-protection-grid">

                <div class="loss-protection-image">
                    <img
                        src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/loss-prevention/loss-prevention-2.webp'); ?>"
                        alt="Security officer providing loss prevention support">

                    <div class="loss-image-badge">
                        <strong>24/7 AWARENESS</strong>
                        <span>Security built around your operation</span>
                    </div>
                </div>


                <div class="loss-protection-content">
                    <span class="eyebrow">PREVENTION &amp; DETECTION</span>

                    <h2>
                        Security That
                        <span>Stays Alert.</span>
                    </h2>

                    <p class="loss-lead">
                        Our loss prevention services combine visibility,
                        vigilance, and established procedures to create a
                        stronger security environment.
                    </p>

                    <div class="loss-protection-list">

                        <div class="loss-protection-item">
                            <span class="loss-item-icon">
                                <i class="bi bi-eye"></i>
                            </span>
    ...
    <!-- =========================================================
         APPROACH
    ========================================================== -->
    <section class="loss-approach">
        <div class="container">

            <div class="loss-section-header loss-approach-header">
                <div>
            ...
            <div class="loss-approach-track">

                <article class="loss-approach-card">

                    <div class="loss-approach-icon">
                        <i class="bi bi-search"></i>
                    </div>

                    <div class="loss-approach-card-content">
                        <h3>Assess</h3>

                        <p>
                            Review your property, operations, assets, and existing
    ...
    <section class="loss-industries">
        <div class="container">
            ...
            <div class="loss-industry-grid">

                <article class="loss-industry-card">
                    <div class="loss-industry-icon">
    ...
    <!-- =========================================================
         WHY ADVENT
    ========================================================== -->
    <section class="loss-why-advent">
        <div class="container">

            <div class="loss-why-grid">

                <div class="loss-why-heading">
                ...
                <div class="loss-why-content">

                    <div class="loss-why-points">
    ...
    <!-- =========================================================
         RELATED SERVICES
    ========================================================== -->
    <section class="content-section related-services loss-related">
        <div class="container">
...
========================================================== -->
    ...
    <!-- =========================================================
         CTA
    ========================================================== -->
    <section class="assessment-cta loss-cta">
        <div class="container">
